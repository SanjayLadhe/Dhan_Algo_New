...
def check_pe_entry_conditions(chart, name, orderbook, no_of_orders_placed):
    ...
    try:
        ...
        print(f" PE Buy Condition {name} : RSI<60={sc1}, CrossBelow={sc2}, "
              f"Close<LongStop={sc3}, Close<FractalLow={sc4}, Close<VWAP={sc5}")
...
def check_pe_option_conditions(options_chart_Res, pe_name, name, orderbook, no_of_orders_placed):
    ...
    try:
        ...
        print(f" PE Option Buy Condition {pe_name} : RSI>60={bc1_opt}, CrossAbove={bc2_opt}, "
