...
def check_ce_entry_conditions(chart, name, orderbook, no_of_orders_placed):
    ...
    try:
        ...
        print(f" CE Buy Condition {name} : RSI>60={bc1}, CrossAbove={bc2}, "
              f"Close>LongStop={bc3}, Close>FractalHigh={bc4}, Close>VWAP={bc5}")
...
def check_ce_option_conditions(options_chart_Res, ce_name, name, orderbook, no_of_orders_placed):
    ...
    try:
        ...
        print(f" CE Option Buy Condition {ce_name} : RSI>60={bc1_opt}, CrossAbove={bc2_opt}, "
              f"Close>LongStop={bc3_opt}, Close>FractalHigh={bc4_opt}, Close>VWAP={bc5_opt}")
...
def place_ce_entry_order(tsl, name, ce_name, lot_size, options_chart_Res, atr_multipler, 
    ...
    try:
        ...
        message = f"CE Entry Done - {name} ({ce_name})\n\n{message}"
