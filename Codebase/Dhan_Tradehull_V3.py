...
class Tradehull:
    ...
    def __init__(self, ClientCode: str, token_id: str):
        ...
        try:
            ...
            self.stock_step_df = {'AARTIIND': 5, 'ABB': 100, 'ABCAPITAL': 2.5, 'ABFRL': 5, 'ACC': 20, 'ADANIENSOL': 20,
                                  'ADANIENT': 20, 'ADANIGREEN': 20, 'ADANIPORTS': 20, 'ALKEM': 50, 'AMBUJACEM': 5,
                                  'ANGELONE': 50, 'APLAPOLLO': 20, 'APOLLOHOSP': 50, 'APOLLOTYRE': 5, 'ASHOKLEY': 2.5,
                                  'ASIANPAINT': 20, 'ASTRAL': 20, 'ATGL': 10, 'AUBANK': 5, 'AUROPHARMA': 20,
                                  'AXISBANK': 10, 'BAJAJ-AUTO': 100, 'BAJAJFINSV': 20, 'BAJFINANCE': 100,
                                  'BALKRISIND': 20, 'BANDHANBNK': 2.5, 'BANKBARODA': 2.5, 'BANKINDIA': 1, 'BEL': 5,
                                  'BHARATFORG': 20, 'BHARTIARTL': 20, 'BHEL': 5, 'BIOCON': 5, 'BOSCHLTD': 250,
                                  'BPCL': 5, 'BRITANNIA': 50, 'BSE': 250, 'BSOFT': 5, 'CAMS': 50, 'CANBK': 1,
                                  'CDSL': 20, 'CESC': 2.5, 'CGPOWER': 10, 'CHAMBLFERT': 10, 'CHOLAFIN': 20, 'CIPLA': 20,
                                  'COALINDIA': 5, 'COFORGE': 100, 'COLPAL': 20, 'CONCOR': 10, 'CROMPTON': 5,
                                  'CUMMINSIND': 50, 'CYIENT': 20, 'DABUR': 5, 'DALBHARAT': 20, 'DEEPAKNTR': 20,
                                  'DELHIVERY': 5, 'DIVISLAB': 50, 'DIXON': 250, 'DLF': 10, 'DMART': 50, 'DRREDDY': 10,
                                  'EICHERMOT': 50, 'ESCORTS': 50, 'ETERNAL': 5, 'EXIDEIND': 5, 'FEDERALBNK': 2.5,
                                  'GAIL': 2.5, 'GLENMARK': 20, 'GMRAIRPORT': 1, 'GODREJCP': 10, 'GODREJPROP': 50,
                                  'GRANULES': 10, 'GRASIM': 20, 'HAL': 50, 'HAVELLS': 20, 'HCLTECH': 40, 'HDFCAMC': 50,
                                  'HDFCBANK': 40, 'HDFCLIFE': 5, 'HEROMOTOCO': 50, 'HFCL': 1, 'HINDALCO': 10,
                                  'HINDCOPPER': 5, 'HINDPETRO': 5, 'HINDUNILVR': 20, 'HINDZINC': 10, 'HUDCO': 5,
                                  'ICICIBANK': 10, 'ICICIGI': 20, 'ICICIPRULI': 5, 'IDEA': 1, 'IDFCFIRSTB': 1,
                                  'IEX': 2.5, 'IGL': 2.5, 'IIFL': 5, 'INDHOTEL': 10, 'INDIANB': 10, 'INDIGO': 50,
                                  'INDUSINDBK': 10, 'INDUSTOWER': 5, 'INFY': 20, 'INOXWIND': 5, 'IOC': 1, 'IRB': 1,
                                  'IRCTC': 10, 'IREDA': 2.5, 'IRFC': 2.5, 'ITC': 5, 'JINDALSTEL': 10, 'JIOFIN': 2.5,
                                  'JSL': 10, 'JSWENERGY': 10, 'JSWSTEEL': 10, 'JUBLFOOD': 10, 'KALYANKJIL': 10,
                                  'KEI': 50, 'KOTAKBANK': 20, 'KPITTECH': 20, 'LAURUSLABS': 10, 'LICHSGFIN': 10,
                                  'LICI': 10, 'LODHA': 20, 'LT': 20, 'LTF': 2.5, 'LTIM': 50, 'LUPIN': 20, 'M&M': 50,
                                  'M&MFIN': 5, 'MANAPPURAM': 5, 'MARICO': 10, 'MARUTI': 100, 'MAXHEALTH': 20,
                                  'MCX': 100, 'MFSL': 20, 'MGL': 20, 'MOTHERSON': 2.5, 'MPHASIS': 20, 'MRF': 500,
                                  'MUTHOOTFIN': 20, 'NATIONALUM': 5, 'NAUKRI': 20, 'NBCC': 1, 'NCC': 2.5,
                                  'NESTLEIND': 20, 'NHPC': 1, 'NMDC': 1, 'NTPC': 5, 'NYKAA': 2.5, 'OBEROIRLTY': 20,
                                  'OFSS': 100, 'OIL': 10, 'ONGC': 2.5, 'PAGEIND': 500, 'PATANJALI': 20, 'PAYTM': 20,
                                  'PEL': 20, 'PERSISTENT': 100, 'PETRONET': 5, 'PFC': 10, 'PHOENIXLTD': 50,
                                  'PIDILITIND': 20, 'PIIND': 50, 'PNB': 1, 'PNBHOUSING': 20, 'POLICYBZR': 20,
                                  'POLYCAB': 100, 'POONAWALLA': 5, 'POWERGRID': 2.5, 'PRESTIGE': 20, 'RAMCOCEM': 10,
                                  'RBLBANK': 2.5, 'RECLTD': 10, 'RELIANCE': 10, 'SAIL': 2.5, 'SBICARD': 10,
                                  'SBILIFE': 20, 'SBIN': 10, 'SHREECEM': 250, 'SHRIRAMFIN': 10, 'SIEMENS': 100,
                                  'SJVN': 1, 'SOLARINDS': 250, 'SONACOMS': 10, 'SRF': 50, 'SUNPHARMA': 20,
                                  'SUPREMEIND': 50, 'SYNGENE': 10, 'TATACHEM': 10, 'TATACOMM': 20, 'TATACONSUM': 10,
                                  'TATAELXSI': 50, 'TATAMOTORS': 10, 'TATAPOWER': 5, 'TATASTEEL': 2.5, 'TATATECH': 10,
                                  'TCS': 20, 'TECHM': 20, 'TIINDIA': 50, 'TITAGARH': 20, 'TITAN': 20, 'TORNTPHARM': 50,
                                  'TORNTPOWER': 20, 'TRENT': 100, 'TVSMOTOR': 20, 'ULTRACEMCO': 100, 'UNIONBANK': 2.5,
                                  'UNITDSPR': 20, 'UPL': 10, 'VBL': 10, 'VEDL': 10, 'VOLTAS': 20, 'WIPRO': 2.5,
                                  'YESBANK': 1, 'ZYDUSLIFE': 10}
            ...
            self.correct_list = {'AARTIIND': 5, 'ABB': 100, 'ABCAPITAL': 2.5, 'ABFRL': 5, 'ACC': 20, 'ADANIENSOL': 20,
                                 'ADANIENT': 20, 'ADANIGREEN': 20, 'ADANIPORTS': 20, 'ALKEM': 50, 'AMBUJACEM': 5,
                                 'ANGELONE': 50, 'APLAPOLLO': 20, 'APOLLOHOSP': 50, 'APOLLOTYRE': 5, 'ASHOKLEY': 2.5,
                                 'ASIANPAINT': 20, 'ASTRAL': 20, 'ATGL': 10, 'AUBANK': 5, 'AUROPHARMA': 20,
                                 'AXISBANK': 10, 'BAJAJ-AUTO': 100, 'BAJAJFINSV': 20, 'BAJFINANCE': 100,
                                 'BALKRISIND': 20, 'BANDHANBNK': 2.5, 'BANKBARODA': 2.5, 'BANKINDIA': 1, 'BEL': 5,
                                 'BHARATFORG': 20, 'BHARTIARTL': 20, 'BHEL': 5, 'BIOCON': 5, 'BOSCHLTD': 250, 'BPCL': 5,
                                 'BRITANNIA': 50, 'BSE': 250, 'BSOFT': 5, 'CAMS': 50, 'CANBK': 1, 'CDSL': 20,
                                 'CESC': 2.5, 'CGPOWER': 10, 'CHAMBLFERT': 10, 'CHOLAFIN': 20, 'CIPLA': 20,
                                 'COALINDIA': 5, 'COFORGE': 100, 'COLPAL': 20, 'CONCOR': 10, 'CROMPTON': 5,
                                 'CUMMINSIND': 50, 'CYIENT': 20, 'DABUR': 5, 'DALBHARAT': 20, 'DEEPAKNTR': 20,
                                 'DELHIVERY': 5, 'DIVISLAB': 50, 'DIXON': 250, 'DLF': 10, 'DMART': 50, 'DRREDDY': 10,
                                 'EICHERMOT': 50, 'ESCORTS': 50, 'ETERNAL': 5, 'EXIDEIND': 5, 'FEDERALBNK': 2.5,
                                 ...
                                 'KEI': 50, 'KOTAKBANK': 20, 'KPITTECH': 20, 'LAURUSLABS': 10, 'LICHSGFIN': 10,
                                 'LICI': 10, 'LODHA': 20, 'LT': 20, 'LTF': 2.5, 'LTIM': 50, 'LUPIN': 20, 'M&M': 50,
                                 'M&MFIN': 5, 'MANAPPURAM': 5, 'MARICO': 10, 'MARUTI': 100, 'MAXHEALTH': 20, 'MCX': 100,
                                 'MFSL': 20, 'MGL': 20, 'MOTHERSON': 2.5, 'MPHASIS': 20, 'MRF': 500, 'MUTHOOTFIN': 20,
                                 'NATIONALUM': 5, 'NAUKRI': 20, 'NBCC': 1, 'NCC': 2.5, 'NESTLEIND': 20, 'NHPC': 1,
                                 'NMDC': 1, 'NTPC': 5, 'NYKAA': 2.5, 'OBEROIRLTY': 20, 'OFSS': 100, 'OIL': 10,
                                 'ONGC': 2.5, 'PAGEIND': 500, 'PATANJALI': 20, 'PAYTM': 20, 'PEL': 20,
                                 'PERSISTENT': 100, 'PETRONET': 5, 'PFC': 10, 'PHOENIXLTD': 50, 'PIDILITIND': 20,
                                 'PIIND': 50, 'PNB': 1, 'PNBHOUSING': 20, 'POLICYBZR': 20, 'POLYCAB': 100,
                                 'POONAWALLA': 5, 'POWERGRID': 2.5, 'PRESTIGE': 20, 'RAMCOCEM': 10, 'RBLBANK': 2.5,
                                 'RECLTD': 10, 'RELIANCE': 10, 'SAIL': 2.5, 'SBICARD': 10, 'SBILIFE': 20, 'SBIN': 10,
                                 'SHREECEM': 250, 'SHRIRAMFIN': 10, 'SIEMENS': 100, 'SJVN': 1, 'SOLARINDS': 250,
                                 'SONACOMS': 10, 'SRF': 50, 'SUNPHARMA': 20, 'SUPREMEIND': 50, 'SYNGENE': 10,
                                 'TATACHEM': 10, 'TATACOMM': 20, 'TATACONSUM': 10, 'TATAELXSI': 50, 'TATAMOTORS': 10,
                                 'TATAPOWER': 5, 'TATASTEEL': 2.5, 'TATATECH': 10, 'TCS': 20, 'TECHM': 20,
                                 'TIINDIA': 50, 'TITAGARH': 20, 'TITAN': 20, 'TORNTPHARM': 50, 'TORNTPOWER': 20,
                                 'TRENT': 100, 'TVSMOTOR': 20, 'ULTRACEMCO': 100, 'UNIONBANK': 2.5, 'UNITDSPR': 20,
                                 'UPL': 10, 'VBL': 10, 'VEDL': 10, 'VOLTAS': 20, 'WIPRO': 2.5, 'YESBANK': 1,
                                 'ZYDUSLIFE': 10}
