...
set twistedWhl=%~dp0twisted-25.5.0-py3-none-any.whl
set taLibWhl=%~dp0ta_lib-0.6.5-cp311-cp311-win_amd64.whl

if not exist "%twistedWhl%" (
    echo ====================================================================
    echo ERROR: Ttwisted-25.5.0-py3-none-any.whl not found in the script directory.
...
if not exist "%taLibWhl%" (
    echo ====================================================================
    echo ERROR: ta_lib-0.6.5-cp311-cp311-win_amd64.whl not found in the script directory.
    echo Please ensure the file is in the same directory as this script.
...
if "%pyversion%"=="" (
    echo ====================================================================
    echo Python is not installed or not added to PATH. Please install Python 3.11.9.
    echo ====================================================================
    timeout /t 20
    exit /b
)
...
if "%pyversion%" NEQ "3.11.9" (
    echo ====================================================================
    echo Your Python version is not 3.11.9. Please uninstall all other versions.
...
pip install "%~dp0twisted-25.5.0-py3-none-any.whl"
pip install "%~dp0ta_lib-0.6.5-cp311-cp311-win_amd64.whl"
